...
func HasCandidate() predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(CandidateTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, CandidateTable, CandidatePrimaryKey...),
		)
...
func HasCandidateWith(preds ...predicate.Candidate) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasJob() predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(JobTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, true, JobTable, JobColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasJobWith(preds ...predicate.Job) predicate.Skill {
	return predicate.Skill(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
