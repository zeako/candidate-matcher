...
func Title(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleEQ(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldTitle), v))
	})
}
...
func TitleNEQ(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleIn(vs ...string) predicate.Candidate {
...
func TitleNotIn(vs ...string) predicate.Candidate {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TitleGT(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleGTE(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleLT(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleLTE(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleContains(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleHasPrefix(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleHasSuffix(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleEqualFold(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func TitleContainsFold(v string) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func HasSkills() predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
...
func HasSkillsWith(preds ...predicate.Skill) predicate.Candidate {
	return predicate.Candidate(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
